...
export default function Pricing() {
  return (
    <div className="w-[1440px] h-[134px] max-sm:  ">
      ...
      <Link className="text-[23px] ml-8 font-medium hover:color-red " href="/order">Order      </Link>
      <Link className="text-[23px] ml-8 font-medium" href="/member">Member        </Link>
      </div>
 ...
 <b className="underline"> journey at a time</b>
      ...
      <div className="h-[1240px] w-[148px] text-[#000000] relative top-[24px] left-[100px] gap-[40px] flex">
        <div className="h-[160px] w-[222px] font-bold text-[48px] leading-[44.8px] flex max:sm-text-[25.2px] ">
          <span> ASL PIZZA`S </span>
          </div>
